# faire deux normalisations différentes
# gérer none pour normalisation
# mieux gérer titres de graphiques + nom des fichiers
# regarder si rapide pour délogger dans les plots
# ajouter quatrième colonne dans conditions pour le nom qu'on veut
...
output_dir = args[1]
max_quant_dir = args[2]

library(yaml)
args = read_yaml(args[3])
